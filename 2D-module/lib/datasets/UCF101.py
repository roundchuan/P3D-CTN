...
class UCF101(imdb):
    def __init__(self, image_set, PHASE, mat_annot_file = None):
        ...
        self._annot_path = "/data/wjc/act_anno/UCF101_24Action_Detection_Annotations/UCF101_24_Annotations" # you only have annotations in RGB data folder
        if 'RGB' in image_set and 'FLOW' in image_set:
            ...
            if self._MOD=='RGB': self._data_path = '/data/wjc/caffe_act1/data/UCF101/Frames'
    ...
    def get_annot_video(self, videoname, label=None):
        ...
        if videoname in ["Biking/v_Biking_g08_c06", "CliffDiving/v_CliffDiving_g23_c04", "HorseRiding/v_HorseRiding_g15_c04","TennisSwing/v_TennisSwing_g09_c01","TennisSwing/v_TennisSwing_g09_c02","TennisSwing/v_TennisSwing_g14_c04","RopeClimbing/v_RopeClimbing_g02_c01"]: return [] # this file is corrupted
